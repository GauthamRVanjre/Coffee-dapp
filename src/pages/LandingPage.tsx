  ...
  const favorites = [
    {
      ...
      description: 'Espresso with vanilla-flavored syrup, steamed milk, and caramel',
      price: 5.99,
  ...
  const features = [
    {
      ...
      description: 'Premium blends with higher caffeine content for that extra energy'
    },
    {
      icon: '🥗',
      title: 'Health-Conscious Options',
      description: 'Organic, low-calorie, and plant-based alternatives available'
    },
    {
      icon: '📶',
  ...
  const events = [
    {
      ...
      image: 'https://images.pexels.com/photos/1181403/pexels-photo-1181403.jpeg?auto=compress&cs=tinysrgb&w=600'
    },
    {
      title: 'Coffee Date Nights',
      description: 'Special romantic ambiance with live acoustic music on Fridays',
    ...
    },
    {
      ...
      description: 'Experience diverse cultures through coffee and performances',
    ...
    <div className="landing-page">
        ...
        <div className="hero-overlay">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              ...
              <button onClick={() => document.getElementById('about')?.scrollIntoView({ behavior: 'smooth' })} className="btn btn-secondary">Learn More</button>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="about-content">
            <div className="about-text">
              ...
              <p className="section-description">
                At Brew Haven, we believe in the art of coffee. Our journey begins in the misty highlands of Ethiopia and Colombia, where we personally source the finest coffee beans from sustainable farms.
              </p>
              <p className="section-description">
                Each bean is carefully selected, ensuring only the highest quality makes it to your cup. Our master roasters craft small batches with precision, bringing out unique flavor profiles that celebrate the origin and terroir of each region.
              </p>
              <p className="section-description">
                From farm to cup, we maintain the highest standards of excellence, ensuring every sip delivers an unforgettable experience. Our commitment to quality, sustainability, and community drives everything we do.
              </p>
            </div>
            <div className="about-images">
              <img src="https://images.pexels.com/photos/4350061/pexels-photo-4350061.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Coffee beans" className="about-image" />
              <img src="https://images.pexels.com/photos/2711959/pexels-photo-2711959.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Coffee preparation" className="about-image" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="favorites" className="favorites-section">
        <div className="section-container">
          ...
          <p className="section-subtitle">Discover what keeps our community coming back</p>
      ...
      <section id="features" className="features-section">
        <div className="section-container">
          ...
          <p className="section-subtitle">Experience coffee culture at its finest</p>
      ...
      <section id="events" className="events-section">
        <div className="section-container">
          ...
          <p className="section-subtitle">Join our vibrant community gatherings</p>
      ...
      <section id="membership" className="membership-section">
        <div className="section-container">
          ...
          <p className="section-subtitle">Unlock exclusive benefits and rewards</p>
          ...
          <div className="membership-content">
            ...
            <div className="membership-image">
              <img src="https://images.pexels.com/photos/3184192/pexels-photo-3184192.jpeg?auto=compress&cs=tinysrgb&w=800" alt="Membership benefits" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="team" className="team-section">
        <div className="section-container">
          ...
          <p className="section-subtitle">The passionate people behind your perfect cup</p>
